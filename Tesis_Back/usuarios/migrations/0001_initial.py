# Generated by Django 5.2.5 on 2025-08-18 02:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('matricula_id', models.CharField(blank=True, max_length=50)),
                ('telefono', models.CharField(blank=True, max_length=30, validators=[django.core.validators.RegexValidator('^[0-9+\\-() ]*$', 'Formato de teléfono inválido')])),
                ('creado_en', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estudio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='membresias', to='usuarios.estudiojuridico')),
            ...
            options={
                ...
                'unique_together': {('usuario', 'estudio', 'rol')},
            },
        ),
    ]
